...
import { spotifyAPI, ARTIST_ID, ProcessedRelease } from "@/lib/spotify";
  ...
  return (
    <div className="min-h-screen bg-cyber-dark overflow-hidden relative grid-bg">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div
          className="absolute top-20 left-10 w-32 h-32 rounded-full border-2 border-neon-pink animate-float opacity-60"
          style={{
        ...
        <div
          className="absolute top-60 right-20 w-64 h-64 animate-float delay-1000"
          style={{
        ...
        >
          ...
          >
            <path
              d="M0,0 L12,8 L16,4 L24,20 L32,8"
        ...
        <div
          className="absolute bottom-32 left-1/3 w-48 h-48 animate-float delay-2000"
          style={{
        ...
        >
          <div className="relative w-full h-full">
            <div
              className="absolute inset-0 border-2 border-neon-violet rounded-full animate-spin opacity-60"
              style={{ animationDuration: "15s" }}
            ></div>
            <div
              className="absolute inset-4 border border-neon-cyan animate-spin opacity-40"
              style={{
            ...
            ></div>
            <div
              className="absolute inset-8 border border-neon-pink animate-spin opacity-60"
              style={{
                animationDuration: "20s",
                clipPath: "polygon(30% 0%, 0% 70%, 70% 100%, 100% 30%)",
              }}
            ></div>
          </div>
        </div>
        ...
        <div
          className="absolute top-1/3 left-20 text-4xl text-neon-violet animate-float opacity-50"
          style={{ transform: `rotate(${mousePosition.x * 0.5}deg)` }}
        >
          ⟐
        </div>
        <div
          className="absolute bottom-1/4 right-32 text-3xl text-neon-cyan animate-neon-flicker opacity-60"
          style={{ transform: `rotate(${-mousePosition.y * 0.3}deg)` }}
        >
          ◈
        </div>
        <div
          className="absolute top-3/4 left-1/4 text-5xl text-neon-green animate-glow-pulse opacity-40"
          style={{ transform: `rotate(${mousePosition.x * 0.2}deg)` }}
        >
          ⟡
        </div>
        <div
          className="absolute top-1/4 right-1/3 text-2xl text-neon-pink animate-float opacity-70"
          style={{ transform: `rotate(${mousePosition.y * 0.4}deg)` }}
        >
          ◉
        </div>
      </div>
        ...
        >
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 max-w-6xl mx-auto">
            ...
            <div className="text-center lg:text-left">
              <h1
                className="text-6xl md:text-8xl font-bold text-neon-pink neon-text animate-neon-flicker mb-4 text-glitch font-mono"
              ...
              <p className="text-lg text-muted-foreground font-mono max-w-2xl">
                Crafting immersive soundscapes from the digital frontier. Where
                cyberpunk meets electronic soul.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-cyber-glow font-mono">
              <p className="text-lg leading-relaxed">
                ...
                Toronto-based Shelby Mackay is an emerging figure whose sound
                challenges traditional boundaries. Her music blends electronic
                disco, experimental textures, and a curiosity that refuses to be
                confined to a single genre.
              </p>
              <p className="text-lg leading-relaxed">
                Mackay's style combines retro influences with forward-thinking
                sensibilities, seamlessly merging pop elements with experimental
                sounds. Drawing from dubstep, '90s R&B, and vintage disco,
                tracks like "Moongirlnonsense" and "Don'tforgetmypeace" showcase
                her ability to merge deep basslines with ethereal vocals and
                glitchy synths.
              </p>
              <p className="text-lg leading-relaxed">
                What sets Shelby apart is her willingness to push against
                conventions—unbound by industry standards, her transparency and
                authenticity resonate in every release. Her music captures both
